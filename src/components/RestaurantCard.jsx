  ...
  return (props) => {
    return (
      <div className="relative inline-block group">
        ...
        >
          <span className="pointer-events-none absolute left-1.5 top-1/2 h-[60%] w-0.5 -translate-y-1/2 rounded-full bg-linear-to-b from-amber-200 to-amber-400 opacity-90"></span>
          <span className="relative z-1 px-2 pl-4 text-[10px]">Promoted</span>
          <span className="pointer-events-none absolute right-1.5 top-1/2 h-2 w-2 -translate-y-1/2 rotate-45 rounded-xs bg-white/60 shadow-[0_0_8px_rgba(255,255,255,0.35)]"></span>
        </span>
